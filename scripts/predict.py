...
def main(_):
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers(
            project_name="prompt_image_alignment",
            config=config.to_dict(),
            init_kwargs={"wandb": {"name": config.run_name, "entity": "diffusion_cornell"}},
        )
    logger.info(f"\n{config}")
    ...
    for time in range(1, 8):
        ...
        cv2.imwrite("/home/yiyi/ddpo-pytorch/save-final/ddpo-infer-step{}.png".format(str(time)), images[2].cpu().numpy().transpose(1,2,0)[:,:,::-1].astype(np.uint8))
